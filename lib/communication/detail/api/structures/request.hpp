...
class Request : public serialization::PackedStruct {
 public:
...
class BufferBuilder<Request, Tags...> {
 public:
  static constexpr size_t overhead_size = sizeof(Request::id_type);
 ...
 public:
  ...
  [[nodiscard]] auto set_data_size(size_t size) {
    ...
    return BufferBuilder<Request, BufferBuilderTag<0>, Tags...>{
        data_size_ + sizeof(Request::data_type::value_type) * size};
  }
