...
class RawData : public serialization::PackedStruct {
 public:
...
class BufferBuilder<RawData, Tags...> {
 public:
  ...
  [[nodiscard]] auto set_data_size(size_t size) {
    ...
    return BufferBuilder<RawData, BufferBuilderTag<0>, Tags...>{
        data_size_ + sizeof(RawData::data_type::value_type) * size};
  }
